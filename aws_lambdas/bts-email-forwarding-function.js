...
var defaultConfig = {
	fromEmail: 'noreply@brunnertechnicalservices.com',
	subjectPrefix: '',
	emailBucket: 'brunnertechnicalservices-mailbox',
	emailKeyPrefix: '',
	forwardMapping: {
		'james@brunnertechnicalservices.com': ['james.jack.brunner@gmail.com'],
		'info@brunnertechnicalservices.com': ['james.jack.brunner@gmail.com'],
		'sales@brunnertechnicalservices.com': ['james.jack.brunner@gmail.com'],
		'admin@brunnertechnicalservices.com': ['james.jack.brunner@gmail.com'],
	},
};
...
exports.parseEvent = function(data) {
	...
	if (
		...
		return Promise.reject(
			new Error('Error: Received invalid SES message.')
		);
	}
		...
		data.s3.copyObject(
			...
			function(err) {
				if (err) {
					...
					return reject(
						new Error(
							'Error: Could not make readable copy of email.'
						)
					);
				}
				...
				data.s3.getObject(
					...
					function(err, result) {
						if (err) {
							...
							return reject(
								new Error(
									'Error: Failed to load message body from S3.'
								)
							);
						}
...
exports.handler = function(event, context, callback, overrides) {
	...
	var data = {
		...
		context: context,
		config:
			overrides && overrides.config ? overrides.config : defaultConfig,
